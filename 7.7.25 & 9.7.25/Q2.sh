...
if test -z "${elastic_ip}"
then
      echo "No Elastic IP is assigned with the instance with id : ${instance_id}"
else
      echo "Elastic Ip ${elastic_ip} is assigned to instance ${instance_id}"
fi      
